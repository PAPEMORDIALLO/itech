            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text">+ 221 00 000 00 00</span>
                    </div>
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        <div class="icon mr-2 d-flex justify-content-center align-items-center">
                            <span class="icon-paper-plane"></span></div>
                        <span class="text">innovation-tech@email.com</span>
                    </div>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">Marché</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="{{ route('produits.index') }}">Nos Produits</a>
                        @auth()
                ...
                <li class="nav-item cta cta-colored">
                    ...
                    <a href="{{route('paniers.index')}}" class="nav-link">

                        <span class="icon-shopping_cart"></span>[@auth {{ $panier_count }} @else 0 @endauth]</a>
                </li>
                        ...
                        <ul>
                            <li>
                                <span class="icon icon-map-marker"></span><span class="text">
                                    Groupe ISI Keur Massar, Dakar Senegal
                                </span></li>
                            <li>
                                <a href="#"><span class="icon icon-phone"></span><span class="text">
                                        +221 00 000 00 00</span>
                                </a>
                            </li>
                            <li>
                                <a href="#"><span class="icon icon-envelope"></span><span class="text">
                                        innovation-tech.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
